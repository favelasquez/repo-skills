...
### ✅ Se agregarán automáticamente al .gitignore:
| Carpeta | Motivo |
|---------|--------|
...
### ✅ Ya están en .gitignore (sin cambios):
- .env
- ...
```
...
> "⚠️ La carpeta `dist/` tiene archivos trackeados en git. Para ignorarla completamente necesitas ejecutar: `git rm -r --cached dist/`"
