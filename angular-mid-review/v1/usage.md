...
```typescript
// ❌ MAL - Sintaxis legacy de RxJS < 5 (Rompe en Angular 6+)
...
```typescript
// ✅ BIEN - Servicios registrados en la raíz automáticamente sin añadir arreglos de Providers en Module
@Injectable({
  providedIn: 'root'
})
...
```typescript
// ❌ MAL - Angular < 8 importaciones mágicas
{ path: 'admin', loadChildren: './admin/admin.module#AdminModule' }

// ✅ BIEN - Angular 8+ Dynamic Imports
